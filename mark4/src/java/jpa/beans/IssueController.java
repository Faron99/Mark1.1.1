...
import jpa.beans.util.JsfUtil;
import jpa.beans.util.PaginationHelper;
...
public class IssueController implements Serializable {
    ...
    private List<Issue> listIssue;///codigo hecho

    public List<Issue> getListIssue() {//codigo hecho
        return listIssue;
    }

    public void setListIssue(List<Issue> listIssue) {//codigo hecho
    ...
    public String prepareView() {
        current = (Issue) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("IssueCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("IssueUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("IssueDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public void buscarIssues(int idtac){
    
    listIssue=ejbFacade.listaIssuesdeTac(idtac);//aqui llamo al metodo de la consulta y el valo que regresa se lo asigno a la lista
